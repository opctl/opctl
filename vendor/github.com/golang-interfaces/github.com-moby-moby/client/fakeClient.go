...
func (fake *FakeClient) NetworkConnect(ctx context.Context, networkID string, containerID string, config *network.EndpointSettings) error {
...
func (fake *FakeClient) NetworkConnectCallCount() int {
	fake.networkConnectMutex.RLock()
	defer fake.networkConnectMutex.RUnlock()
	return len(fake.networkConnectArgsForCall)
}

func (fake *FakeClient) NetworkConnectArgsForCall(i int) (context.Context, string, string, *network.EndpointSettings) {
	fake.networkConnectMutex.RLock()
	defer fake.networkConnectMutex.RUnlock()
...
func (fake *FakeClient) NetworkConnectReturns(result1 error) {
...
func (fake *FakeClient) NetworkConnectReturnsOnCall(i int, result1 error) {
	fake.NetworkConnectStub = nil
...
func (fake *FakeClient) ContainerCreate(ctx context.Context, config *container.Config, hostConfig *container.HostConfig, networkingConfig *network.NetworkingConfig, containerName string) (container.ContainerCreateCreatedBody, error) {
...
func (fake *FakeClient) ContainerCreateCallCount() int {
	fake.containerCreateMutex.RLock()
	defer fake.containerCreateMutex.RUnlock()
	return len(fake.containerCreateArgsForCall)
}

func (fake *FakeClient) ContainerCreateArgsForCall(i int) (context.Context, *container.Config, *container.HostConfig, *network.NetworkingConfig, string) {
	fake.containerCreateMutex.RLock()
	defer fake.containerCreateMutex.RUnlock()
...
func (fake *FakeClient) ContainerCreateReturns(result1 container.ContainerCreateCreatedBody, result2 error) {
...
func (fake *FakeClient) ContainerCreateReturnsOnCall(i int, result1 container.ContainerCreateCreatedBody, result2 error) {
	fake.ContainerCreateStub = nil
...
func (fake *FakeClient) ContainerLogs(ctx context.Context, container string, options types.ContainerLogsOptions) (io.ReadCloser, error) {
...
func (fake *FakeClient) ContainerLogsCallCount() int {
	fake.containerLogsMutex.RLock()
	defer fake.containerLogsMutex.RUnlock()
	return len(fake.containerLogsArgsForCall)
}

func (fake *FakeClient) ContainerLogsArgsForCall(i int) (context.Context, string, types.ContainerLogsOptions) {
	fake.containerLogsMutex.RLock()
	defer fake.containerLogsMutex.RUnlock()
...
func (fake *FakeClient) ContainerLogsReturns(result1 io.ReadCloser, result2 error) {
...
func (fake *FakeClient) ContainerLogsReturnsOnCall(i int, result1 io.ReadCloser, result2 error) {
	fake.ContainerLogsStub = nil
...
func (fake *FakeClient) ContainerRemove(ctx context.Context, containerID string, options types.ContainerRemoveOptions) error {
...
func (fake *FakeClient) ContainerRemoveCallCount() int {
	fake.containerRemoveMutex.RLock()
	defer fake.containerRemoveMutex.RUnlock()
	return len(fake.containerRemoveArgsForCall)
}

func (fake *FakeClient) ContainerRemoveArgsForCall(i int) (context.Context, string, types.ContainerRemoveOptions) {
	fake.containerRemoveMutex.RLock()
	defer fake.containerRemoveMutex.RUnlock()
...
func (fake *FakeClient) ContainerRemoveReturns(result1 error) {
...
func (fake *FakeClient) ContainerRemoveReturnsOnCall(i int, result1 error) {
	fake.ContainerRemoveStub = nil
...
func (fake *FakeClient) ContainerStart(ctx context.Context, containerID string, options types.ContainerStartOptions) error {
...
func (fake *FakeClient) ContainerStartCallCount() int {
	fake.containerStartMutex.RLock()
	defer fake.containerStartMutex.RUnlock()
	return len(fake.containerStartArgsForCall)
}

func (fake *FakeClient) ContainerStartArgsForCall(i int) (context.Context, string, types.ContainerStartOptions) {
	fake.containerStartMutex.RLock()
	defer fake.containerStartMutex.RUnlock()
...
func (fake *FakeClient) ContainerStartReturns(result1 error) {
...
func (fake *FakeClient) ContainerStartReturnsOnCall(i int, result1 error) {
	fake.ContainerStartStub = nil
...
func (fake *FakeClient) ContainerWait(ctx context.Context, containerID string) (int64, error) {
...
func (fake *FakeClient) ContainerWaitReturnsOnCall(i int, result1 int64, result2 error) {
	fake.ContainerWaitStub = nil
...
func (fake *FakeClient) ImagePull(ctx context.Context, ref string, options types.ImagePullOptions) (io.ReadCloser, error) {
...
func (fake *FakeClient) ImagePullCallCount() int {
	fake.imagePullMutex.RLock()
	defer fake.imagePullMutex.RUnlock()
	return len(fake.imagePullArgsForCall)
}

func (fake *FakeClient) ImagePullArgsForCall(i int) (context.Context, string, types.ImagePullOptions) {
	fake.imagePullMutex.RLock()
	defer fake.imagePullMutex.RUnlock()
	return fake.imagePullArgsForCall[i].ctx, fake.imagePullArgsForCall[i].ref, fake.imagePullArgsForCall[i].options
}

func (fake *FakeClient) ImagePullReturns(result1 io.ReadCloser, result2 error) {
...
func (fake *FakeClient) ImagePullReturnsOnCall(i int, result1 io.ReadCloser, result2 error) {
	fake.ImagePullStub = nil
...
func (fake *FakeClient) NetworkCreate(ctx context.Context, name string, options types.NetworkCreate) (types.NetworkCreateResponse, error) {
...
func (fake *FakeClient) NetworkCreateCallCount() int {
	fake.networkCreateMutex.RLock()
	defer fake.networkCreateMutex.RUnlock()
	return len(fake.networkCreateArgsForCall)
}

func (fake *FakeClient) NetworkCreateArgsForCall(i int) (context.Context, string, types.NetworkCreate) {
	fake.networkCreateMutex.RLock()
	defer fake.networkCreateMutex.RUnlock()
	return fake.networkCreateArgsForCall[i].ctx, fake.networkCreateArgsForCall[i].name, fake.networkCreateArgsForCall[i].options
}

func (fake *FakeClient) NetworkCreateReturns(result1 types.NetworkCreateResponse, result2 error) {
...
func (fake *FakeClient) NetworkCreateReturnsOnCall(i int, result1 types.NetworkCreateResponse, result2 error) {
	fake.NetworkCreateStub = nil
...
func (fake *FakeClient) NetworkInspect(ctx context.Context, networkID string, verbose bool) (types.NetworkResource, error) {
...
func (fake *FakeClient) NetworkInspectCallCount() int {
	fake.networkInspectMutex.RLock()
	defer fake.networkInspectMutex.RUnlock()
	return len(fake.networkInspectArgsForCall)
}

func (fake *FakeClient) NetworkInspectArgsForCall(i int) (context.Context, string, bool) {
	fake.networkInspectMutex.RLock()
	defer fake.networkInspectMutex.RUnlock()
...
func (fake *FakeClient) NetworkInspectReturns(result1 types.NetworkResource, result2 error) {
...
func (fake *FakeClient) NetworkInspectReturnsOnCall(i int, result1 types.NetworkResource, result2 error) {
	fake.NetworkInspectStub = nil
...
func (fake *FakeClient) RegistryLogin(ctx context.Context, auth types.AuthConfig) (registry.AuthenticateOKBody, error) {
...
func (fake *FakeClient) RegistryLoginCallCount() int {
	fake.registryLoginMutex.RLock()
	defer fake.registryLoginMutex.RUnlock()
	return len(fake.registryLoginArgsForCall)
}

func (fake *FakeClient) RegistryLoginArgsForCall(i int) (context.Context, types.AuthConfig) {
	fake.registryLoginMutex.RLock()
	defer fake.registryLoginMutex.RUnlock()
	return fake.registryLoginArgsForCall[i].ctx, fake.registryLoginArgsForCall[i].auth
}

func (fake *FakeClient) RegistryLoginReturns(result1 registry.AuthenticateOKBody, result2 error) {
...
func (fake *FakeClient) RegistryLoginReturnsOnCall(i int, result1 registry.AuthenticateOKBody, result2 error) {
	fake.RegistryLoginStub = nil
