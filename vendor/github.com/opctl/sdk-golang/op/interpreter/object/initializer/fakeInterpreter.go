...
type FakeInterpreter struct {
	InterpretStub        func(expression map[string]interface{}, scope map[string]*model.Value, opHandle model.DataHandle) (map[string]interface{}, error)
...
func (fake *FakeInterpreter) Interpret(expression map[string]interface{}, scope map[string]*model.Value, opHandle model.DataHandle) (map[string]interface{}, error) {
	...
	fake.recordInvocation("Interpret", []interface{}{expression, scope, opHandle})
	fake.interpretMutex.Unlock()
	if fake.InterpretStub != nil {
		return fake.InterpretStub(expression, scope, opHandle)
	}
	if specificReturn {
...
func (fake *FakeInterpreter) InterpretArgsForCall(i int) (map[string]interface{}, map[string]*model.Value, model.DataHandle) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
	return fake.interpretArgsForCall[i].expression, fake.interpretArgsForCall[i].scope, fake.interpretArgsForCall[i].opHandle
}

func (fake *FakeInterpreter) InterpretReturns(result1 map[string]interface{}, result2 error) {
...
func (fake *FakeInterpreter) InterpretReturnsOnCall(i int, result1 map[string]interface{}, result2 error) {
	fake.InterpretStub = nil
