...
type fakeCoercer struct {
	CoerceStub        func(value *model.Value) (string, error)
...
func (fake *fakeCoercer) Coerce(value *model.Value) (string, error) {
...
func (fake *fakeCoercer) CoerceReturns(result1 string, result2 error) {
	fake.CoerceStub = nil
...
func (fake *fakeCoercer) CoerceReturnsOnCall(i int, result1 string, result2 error) {
	fake.CoerceStub = nil
