...
type fakeOpCaller struct {
	CallStub        func(inboundScope map[string]*model.Value, opId string, opDirHandle model.DataHandle, rootOpId string, scgOpCall *model.SCGOpCall) error
...
func (fake *fakeOpCaller) Call(inboundScope map[string]*model.Value, opId string, opDirHandle model.DataHandle, rootOpId string, scgOpCall *model.SCGOpCall) error {
	fake.callMutex.Lock()
	...
	fake.callArgsForCall = append(fake.callArgsForCall, struct {
		...
		rootOpId     string
		scgOpCall    *model.SCGOpCall
	}{inboundScope, opId, opDirHandle, rootOpId, scgOpCall})
	fake.recordInvocation("Call", []interface{}{inboundScope, opId, opDirHandle, rootOpId, scgOpCall})
	fake.callMutex.Unlock()
	if fake.CallStub != nil {
		return fake.CallStub(inboundScope, opId, opDirHandle, rootOpId, scgOpCall)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *fakeOpCaller) CallArgsForCall(i int) (map[string]*model.Value, string, model.DataHandle, string, *model.SCGOpCall) {
	fake.callMutex.RLock()
	defer fake.callMutex.RUnlock()
	return fake.callArgsForCall[i].inboundScope, fake.callArgsForCall[i].opId, fake.callArgsForCall[i].opDirHandle, fake.callArgsForCall[i].rootOpId, fake.callArgsForCall[i].scgOpCall
}
