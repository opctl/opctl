...
func pkgManifestDataPackageManifestSchemaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "pkg/manifest/data/package-manifest.schema.json", size: 21576, mode: os.FileMode(420), modTime: time.Unix(1494598895, 0)}
