...
type Fake struct {
	...
	InterpretStub        func(inputArgs map[string]interface{}, inputParams map[string]*model.Param, parentPkgRef, pkgRef string, scope map[string]*model.Value) (map[string]*model.Value, []error)
...
func (fake *Fake) Interpret(inputArgs map[string]interface{}, inputParams map[string]*model.Param, parentPkgRef string, pkgRef string, scope map[string]*model.Value) (map[string]*model.Value, []error) {
	...
	fake.interpretArgsForCall = append(fake.interpretArgsForCall, struct {
		...
		pkgRef       string
		scope        map[string]*model.Value
	}{inputArgs, inputParams, parentPkgRef, pkgRef, scope})
	fake.recordInvocation("Interpret", []interface{}{inputArgs, inputParams, parentPkgRef, pkgRef, scope})
	fake.interpretMutex.Unlock()
	if fake.InterpretStub != nil {
		return fake.InterpretStub(inputArgs, inputParams, parentPkgRef, pkgRef, scope)
	}
	if specificReturn {
...
func (fake *Fake) InterpretArgsForCall(i int) (map[string]interface{}, map[string]*model.Param, string, string, map[string]*model.Value) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
	return fake.interpretArgsForCall[i].inputArgs, fake.interpretArgsForCall[i].inputParams, fake.interpretArgsForCall[i].parentPkgRef, fake.interpretArgsForCall[i].pkgRef, fake.interpretArgsForCall[i].scope
}
