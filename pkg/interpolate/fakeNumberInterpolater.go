...
type fakeNumberInterpolater struct {
	InterpolateStub        func(s string, varName string, varValue float64) string
...
func (fake *fakeNumberInterpolater) Interpolate(s string, varName string, varValue float64) string {
...
func (fake *fakeNumberInterpolater) InterpolateReturnsOnCall(i int, result1 string) {
	fake.InterpolateStub = nil
...
func (fake *fakeNumberInterpolater) Invocations() map[string][][]interface{} {
...
func (fake *fakeNumberInterpolater) recordInvocation(key string, args []interface{}) {
