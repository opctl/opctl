...
func (fake *ContainerEngine) StartContainer(opRunArgs map[string]string, opBundlePath string, opName string, opRunId string, eventPublisher EventPublisher, rootOpRunId string) (err error) {
...
func (fake *ContainerEngine) StartContainerArgsForCall(i int) (map[string]string, string, string, string, EventPublisher, string) {
  fake.startContainerMutex.RLock()
  defer fake.startContainerMutex.RUnlock()
...
var _ ContainerEngine = new(ContainerEngine)
