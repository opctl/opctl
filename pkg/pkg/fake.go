...
type Fake struct {
	...
	CreateOpStub        func(req model.CreateOpReq) (err error)
	...
	GetCollectionStub        func(collectionPackagePath string) (collectionView model.CollectionView, err error)
	...
	GetOpStub        func(opPackagePath string) (opView model.OpView, err error)
	...
	SetCollectionDescriptionStub        func(req model.SetCollectionDescriptionReq) (err error)
	...
	SetOpDescriptionStub        func(req model.SetOpDescriptionReq) (err error)
	...
	TryResolveDefaultCollectionStub        func(req model.TryResolveDefaultCollectionReq) (pathToDefaultCollection string, err error)
...
func (fake *Fake) GetCollection(collectionPackagePath string) (collectionView model.CollectionView, err error) {
	...
	fake.recordInvocation("GetCollection", []interface{}{collectionPackagePath})
	fake.getCollectionMutex.Unlock()
	if fake.GetCollectionStub != nil {
		return fake.GetCollectionStub(collectionPackagePath)
	} else {
...
func (fake *Fake) GetCollectionArgsForCall(i int) string {
	fake.getCollectionMutex.RLock()
	defer fake.getCollectionMutex.RUnlock()
	return fake.getCollectionArgsForCall[i].collectionPackagePath
}
...
func (fake *Fake) GetOp(opPackagePath string) (opView model.OpView, err error) {
	fake.getOpMutex.Lock()
	fake.getOpArgsForCall = append(fake.getOpArgsForCall, struct {
		opPackagePath string
	}{opPackagePath})
	fake.recordInvocation("GetOp", []interface{}{opPackagePath})
	fake.getOpMutex.Unlock()
	if fake.GetOpStub != nil {
		return fake.GetOpStub(opPackagePath)
	} else {
...
func (fake *Fake) GetOpArgsForCall(i int) string {
	fake.getOpMutex.RLock()
	defer fake.getOpMutex.RUnlock()
	return fake.getOpArgsForCall[i].opPackagePath
}
