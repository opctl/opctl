...
func NewBoltDBEventRepo(
	...
	return &boltDBEventRepo{
		db: db,
	}
}

type boltDBEventRepo struct {
	db               *bolt.DB
...
// O(1); threadsafe
func (this *boltDBEventRepo) Add(event model.Event) error {
...
func (this *boltDBEventRepo) List(ctx context.Context,
