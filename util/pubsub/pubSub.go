...
func (ps *pubSub) Subscribe(
  ...
  go func() {
    ...
    ps.subscriptions[publishEventChannel] = subscription
...
func (ps *pubSub) Publish(
  ...
  for publishEventChannel, subscription := range ps.subscriptions {
    ...
    if !isRootOpIdExcludedByFilter(RootOpId, subscription.Filter) {
      ...
      // other subscriptions
      ps.publishToSubscription(publishEventChannel, subscription, event)
