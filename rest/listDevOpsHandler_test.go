...
var _ = Describe("listDevOpsHandler", func() {

  Context("ServeHTTP() method", func() {
    It("should return StatusCode of 400 if projectUrl is malformed in Request", func() {

      /* arrange */
      objectUnderTest := listDevOpsHandler{}
      recorder := httptest.NewRecorder()
      m := mux.NewRouter()
      m.Handle(listDevOpsRelUrlTemplate, objectUnderTest)
      ...
      httpReq.URL.Path = strings.Replace(listDevOpsRelUrlTemplate, "{projectUrl}", providedProjectUrl, 1)
