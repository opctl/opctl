...
describe('validate', () => {
  ...
  describe('param.array not falsy', () => {
    test('it calls arrayValidator.validate w/ expected args & returns result', () => {
      /* arrange */
  ...
  describe('param.boolean not falsy', () => {
    test('it calls booleanValidator.validate w/ expected args & returns result', () => {
      /* arrange */
  ...
  describe('param.dir not falsy', () => {
    test('it calls dirValidator.validate w/ expected args & returns result', () => {
      /* arrange */
  ...
  describe('param.file not falsy', () => {
    test('it calls fileValidator.validate w/ expected args & returns result', () => {
      /* arrange */
  ...
  describe('param.number not falsy', () => {
    test('it calls numberValidator.validate w/ expected args & returns result', () => {
      /* arrange */
  ...
  describe('param.object not falsy', () => {
    test('it calls objectValidator.validate w/ expected args & returns result', () => {
      /* arrange */
  ...
  describe('param.socket not falsy', () => {
    test('it calls socketValidator.validate w/ expected args & returns result', () => {
      /* arrange */
  ...
  describe('param.string not falsy', () => {
    test('it calls stringValidator.validate w/ expected args & returns result', () => {
      /* arrange */
