...
describe('toArray', () => {
  ...
  describe('value is array', () => {
    it('should return expected result', async () => {
      ...
      /* act */
      const actualResult = await objectUnderTest.toArray(providedValue)
  ...
  describe('value is boolean', () => {
    it('should return expected result', async () => {
      ...
      /* act/assert */
      await expect(objectUnderTest.toArray(providedValue))
        .rejects
  ...
  describe('value is file', () => {
    it('should call nodeApiClient.dataGet w/ expected args', async () => {
      ...
      /* act */
      await objectUnderTest.toArray(providedValue)
  ...
  describe('value isnt array/boolean/dir/file/socket/string', () => {
    it('returns expected result', async () => {
      /* arrange */
