...
func (this _compositionRoot) StartContainerUseCase() startContainerUseCase {
  return this.startContainerUseCase
}

func (this _compositionRoot) EnsureContainerRemovedUseCase() ensureContainerRemovedUseCase {
