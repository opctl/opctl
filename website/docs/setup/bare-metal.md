...
```bash
curl -L https://github.com/opctl/opctl/releases/download/0.1.36/opctl0.1.36.darwin.tgz | tar -xzv -C /usr/local/bin
```
...
download and run the [windows installer](https://github.com/opctl/opctl/releases/download/0.1.36/opctl0.1.36.windows.msi)
