...
type fakeValidator struct {
	ValidateStub        func(value *string) []error
...
func (fake *fakeValidator) Validate(value *string) []error {
	fake.validateMutex.Lock()
	ret, specificReturn := fake.validateReturnsOnCall[len(fake.validateArgsForCall)]
	fake.validateArgsForCall = append(fake.validateArgsForCall, struct {
		value *string
	}{value})
	fake.recordInvocation("Validate", []interface{}{value})
	fake.validateMutex.Unlock()
	if fake.ValidateStub != nil {
		return fake.ValidateStub(value)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *fakeValidator) ValidateArgsForCall(i int) *string {
	fake.validateMutex.RLock()
	defer fake.validateMutex.RUnlock()
	return fake.validateArgsForCall[i].value
}
