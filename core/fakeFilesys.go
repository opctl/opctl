...
func (fake *fakeFilesys) CreateDevOpDir(devOpName string) (err error) {
...
func (fake *fakeFilesys) CreateDevOpDirCallCount() int {
  fake.createDevOpDirMutex.RLock()
  defer fake.createDevOpDirMutex.RUnlock()
  return len(fake.createDevOpDirArgsForCall)
}

func (fake *fakeFilesys) CreateDevOpDirArgsForCall(i int) string {
  fake.createDevOpDirMutex.RLock()
  defer fake.createDevOpDirMutex.RUnlock()
  return fake.createDevOpDirArgsForCall[i].devOpName
}

func (fake *fakeFilesys) CreateDevOpDirReturns(result1 error) {
...
func (fake *fakeFilesys) CreatePipelineDir(pipelineName string) (err error) {
...
func (fake *fakeFilesys) CreatePipelineDirCallCount() int {
  fake.createPipelineDirMutex.RLock()
  defer fake.createPipelineDirMutex.RUnlock()
  return len(fake.createPipelineDirArgsForCall)
}

func (fake *fakeFilesys) CreatePipelineDirArgsForCall(i int) string {
  fake.createPipelineDirMutex.RLock()
  defer fake.createPipelineDirMutex.RUnlock()
  return fake.createPipelineDirArgsForCall[i].pipelineName
}

func (fake *fakeFilesys) CreatePipelineDirReturns(result1 error) {
...
func (fake *fakeFilesys) ListNamesOfDevOpDirs() (namesOfDevOpDirs []string, err error) {
...
func (fake *fakeFilesys) ListNamesOfDevOpDirsCallCount() int {
...
func (fake *fakeFilesys) ListNamesOfDevOpDirsReturns(result1 []string, result2 error) {
...
func (fake *fakeFilesys) ListNamesOfPipelineDirs() (namesOfPipelineDirs []string, err error) {
...
func (fake *fakeFilesys) ListNamesOfPipelineDirsCallCount() int {
...
func (fake *fakeFilesys) ListNamesOfPipelineDirsReturns(result1 []string, result2 error) {
...
func (fake *fakeFilesys) ReadDevOpFile(devOpName string) (file []byte, err error) {
...
func (fake *fakeFilesys) ReadDevOpFileCallCount() int {
  fake.readDevOpFileMutex.RLock()
  defer fake.readDevOpFileMutex.RUnlock()
  return len(fake.readDevOpFileArgsForCall)
}

func (fake *fakeFilesys) ReadDevOpFileArgsForCall(i int) string {
  fake.readDevOpFileMutex.RLock()
  defer fake.readDevOpFileMutex.RUnlock()
  return fake.readDevOpFileArgsForCall[i].devOpName
}

func (fake *fakeFilesys) ReadDevOpFileReturns(result1 []byte, result2 error) {
...
func (fake *fakeFilesys) ReadPipelineFile(pipelineName string) (file []byte, err error) {
...
func (fake *fakeFilesys) ReadPipelineFileCallCount() int {
  fake.readPipelineFileMutex.RLock()
  defer fake.readPipelineFileMutex.RUnlock()
  return len(fake.readPipelineFileArgsForCall)
}

func (fake *fakeFilesys) ReadPipelineFileArgsForCall(i int) string {
  fake.readPipelineFileMutex.RLock()
  defer fake.readPipelineFileMutex.RUnlock()
  return fake.readPipelineFileArgsForCall[i].pipelineName
}

func (fake *fakeFilesys) ReadPipelineFileReturns(result1 []byte, result2 error) {
...
func (fake *fakeFilesys) SaveDevOpFile(devOpName string, data []byte) (err error) {
...
func (fake *fakeFilesys) SavePipelineFile(pipelineName string, data []byte) (err error) {
