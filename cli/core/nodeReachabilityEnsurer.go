...
//go:generate go run github.com/maxbrunsfeld/counterfeiter/v6 -o ./fakeNodeReachabilityEnsurer.go --fake-name fakeNodeReachabilityEnsurer ./ nodeReachabilityEnsurer
