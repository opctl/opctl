...
type fakeParamSatisfier struct {
...
func (fake *fakeParamSatisfier) Satisfy(options []string, params map[string]*model.Param) (argMap map[string]*model.Data) {
...
func (fake *fakeParamSatisfier) SatisfyCallCount() int {
	fake.satisfyMutex.RLock()
	defer fake.satisfyMutex.RUnlock()
	return len(fake.satisfyArgsForCall)
}

func (fake *fakeParamSatisfier) SatisfyArgsForCall(i int) ([]string, map[string]*model.Param) {
	fake.satisfyMutex.RLock()
	defer fake.satisfyMutex.RUnlock()
	return fake.satisfyArgsForCall[i].options, fake.satisfyArgsForCall[i].params
}

func (fake *fakeParamSatisfier) SatisfyReturns(result1 map[string]*model.Data) {
...
func (fake *fakeParamSatisfier) Invocations() map[string][][]interface{} {
...
func (fake *fakeParamSatisfier) recordInvocation(key string, args []interface{}) {
