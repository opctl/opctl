...
type FakeInterpreter struct {
	InterpretStub        func([]interface{}, types.DataHandle, map[string]*types.Value) (bool, error)
	interpretMutex       sync.RWMutex
	interpretArgsForCall []struct {
		arg1 []interface{}
		arg2 types.DataHandle
...
func (fake *FakeInterpreter) Interpret(arg1 []interface{}, arg2 types.DataHandle, arg3 map[string]*types.Value) (bool, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func([]interface{}, types.DataHandle, map[string]*types.Value) (bool, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) ([]interface{}, types.DataHandle, map[string]*types.Value) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
