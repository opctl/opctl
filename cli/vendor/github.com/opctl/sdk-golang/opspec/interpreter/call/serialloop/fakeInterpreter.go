...
type FakeInterpreter struct {
	InterpretStub        func(model.DataHandle, model.SCGSerialLoop, map[string]*model.Value) (*model.DCGSerialLoop, error)
	interpretMutex       sync.RWMutex
	interpretArgsForCall []struct {
		arg1 model.DataHandle
		arg2 model.SCGSerialLoop
		arg3 map[string]*model.Value
	}
	interpretReturns struct {
		result1 *model.DCGSerialLoop
		result2 error
	}
...
func (fake *FakeInterpreter) Interpret(arg1 model.DataHandle, arg2 model.SCGSerialLoop, arg3 map[string]*model.Value) (*model.DCGSerialLoop, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(model.DataHandle, model.SCGSerialLoop, map[string]*model.Value) (*model.DCGSerialLoop, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (model.DataHandle, model.SCGSerialLoop, map[string]*model.Value) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
...
func (fake *FakeInterpreter) InterpretReturns(result1 *model.DCGSerialLoop, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
...
func (fake *FakeInterpreter) InterpretReturnsOnCall(i int, result1 *model.DCGSerialLoop, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = nil
