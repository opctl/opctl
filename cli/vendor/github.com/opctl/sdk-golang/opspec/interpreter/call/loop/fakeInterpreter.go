...
type FakeInterpreter struct {
	InterpretStub        func(model.DataHandle, *model.SCGLoop, map[string]*model.Value) (*model.DCGLoop, error)
...
func (fake *FakeInterpreter) Interpret(arg1 model.DataHandle, arg2 *model.SCGLoop, arg3 map[string]*model.Value) (*model.DCGLoop, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(model.DataHandle, *model.SCGLoop, map[string]*model.Value) (*model.DCGLoop, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (model.DataHandle, *model.SCGLoop, map[string]*model.Value) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
...
func (fake *FakeInterpreter) InterpretReturns(result1 *model.DCGLoop, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
...
func (fake *FakeInterpreter) InterpretReturnsOnCall(i int, result1 *model.DCGLoop, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = nil
