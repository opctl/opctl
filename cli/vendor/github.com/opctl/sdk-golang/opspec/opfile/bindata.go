...
func githubComOpctlSpecsOpspecOpfileJsonschemaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "github.com/opctl/specs/opspec/opfile/jsonschema.json", size: 40987, mode: os.FileMode(420), modTime: time.Unix(1561600339, 0)}
