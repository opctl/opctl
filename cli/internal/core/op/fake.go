...
func (fake *Fake) Create(arg1 string, arg2 string, arg3 string) {
...
func (fake *Fake) CreateCalls(stub func(string, string, string)) {
	fake.createMutex.Lock()
...
func (fake *Fake) Install(arg1 context.Context, arg2 string, arg3 string, arg4 string, arg5 string) {
...
func (fake *Fake) InstallCalls(stub func(context.Context, string, string, string, string)) {
	fake.installMutex.Lock()
	defer fake.installMutex.Unlock()
	fake.InstallStub = stub
}

func (fake *Fake) InstallArgsForCall(i int) (context.Context, string, string, string, string) {
	fake.installMutex.RLock()
	defer fake.installMutex.RUnlock()
...
func (fake *Fake) Kill(arg1 context.Context, arg2 string) {
	fake.killMutex.Lock()
...
func (fake *Fake) KillCalls(stub func(context.Context, string)) {
	fake.killMutex.Lock()
	defer fake.killMutex.Unlock()
	fake.KillStub = stub
}

func (fake *Fake) KillArgsForCall(i int) (context.Context, string) {
	fake.killMutex.RLock()
	defer fake.killMutex.RUnlock()
...
func (fake *Fake) Validate(arg1 context.Context, arg2 string) {
...
func (fake *Fake) ValidateCalls(stub func(context.Context, string)) {
	fake.validateMutex.Lock()
	defer fake.validateMutex.Unlock()
	fake.ValidateStub = stub
}

func (fake *Fake) ValidateArgsForCall(i int) (context.Context, string) {
	fake.validateMutex.RLock()
	defer fake.validateMutex.RUnlock()
