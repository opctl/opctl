...
func (fake *Fake) NodeCallCount() int {
	fake.nodeMutex.RLock()
	defer fake.nodeMutex.RUnlock()
	return len(fake.nodeArgsForCall)
}

func (fake *Fake) NodeCalls(stub func() node.Node) {
	fake.nodeMutex.Lock()
	defer fake.nodeMutex.Unlock()
	fake.NodeStub = stub
}

func (fake *Fake) NodeReturns(result1 node.Node) {
	fake.nodeMutex.Lock()
	defer fake.nodeMutex.Unlock()
	fake.NodeStub = nil
...
func (fake *Fake) NodeReturnsOnCall(i int, result1 node.Node) {
	fake.nodeMutex.Lock()
	defer fake.nodeMutex.Unlock()
	fake.NodeStub = nil
...
func (fake *Fake) OpCallCount() int {
	fake.opMutex.RLock()
	defer fake.opMutex.RUnlock()
	return len(fake.opArgsForCall)
}

func (fake *Fake) OpCalls(stub func() op.Op) {
	fake.opMutex.Lock()
	defer fake.opMutex.Unlock()
	fake.OpStub = stub
}

func (fake *Fake) OpReturns(result1 op.Op) {
	fake.opMutex.Lock()
	defer fake.opMutex.Unlock()
	fake.OpStub = nil
...
func (fake *Fake) OpReturnsOnCall(i int, result1 op.Op) {
	fake.opMutex.Lock()
	defer fake.opMutex.Unlock()
	fake.OpStub = nil
