...
//go:generate counterfeiter -o ./fakeDockerClient.go --fake-name fakeDockerClient /go/src/github.com/opctl/opctl/sdk/go/vendor/github.com/docker/docker/client/interface.go CommonAPIClient
