...
func (fake *fakeValidator) Validate(value map[string]interface{}, constraints *model.ObjectConstraints) []error {
...
func (fake *fakeValidator) ValidateArgsForCall(i int) (map[string]interface{}, *model.ObjectConstraints) {
	fake.validateMutex.RLock()
	defer fake.validateMutex.RUnlock()
