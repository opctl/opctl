...
type Fake struct {
	ValidateStub        func(value map[string]interface{}, constraints *model.ObjectConstraints) []error
...
func (fake *Fake) Validate(value map[string]interface{}, constraints *model.ObjectConstraints) []error {
...
func (fake *Fake) ValidateArgsForCall(i int) (map[string]interface{}, *model.ObjectConstraints) {
	fake.validateMutex.RLock()
	defer fake.validateMutex.RUnlock()
