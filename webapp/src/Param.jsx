...
import ParamArray from './Param_Array';
...
export default function Param(props) {
  ...
  if (props.param.array) {
    return (<ParamArray name={props.name} array={props.param.array}/>);
    ...
    return (<ParamObject name={props.name} object={props.param.object}/>);
