...
type fakeValidator struct {
	ValidateStub        func(value *float64, constraints *model.NumberConstraints) []error
...
func (fake *fakeValidator) Validate(value *float64, constraints *model.NumberConstraints) []error {
...
func (fake *fakeValidator) ValidateArgsForCall(i int) (*float64, *model.NumberConstraints) {
	fake.validateMutex.RLock()
	defer fake.validateMutex.RUnlock()
