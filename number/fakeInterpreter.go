...
func (fake *fakeInterpreter) Interpret(scope map[string]*model.Value, expression string) (float64, error) {
...
func (fake *fakeInterpreter) InterpretReturns(result1 float64, result2 error) {
...
func (fake *fakeInterpreter) InterpretReturnsOnCall(i int, result1 float64, result2 error) {
	fake.InterpretStub = nil
