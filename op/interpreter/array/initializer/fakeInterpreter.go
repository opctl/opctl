...
type FakeInterpreter struct {
	InterpretStub        func(expression []interface{}, scope map[string]*model.Value, opHandle model.DataHandle) ([]interface{}, error)
...
func (fake *FakeInterpreter) Interpret(expression []interface{}, scope map[string]*model.Value, opHandle model.DataHandle) ([]interface{}, error) {
	...
	fake.recordInvocation("Interpret", []interface{}{expressionCopy, scope, opHandle})
...
func (fake *FakeInterpreter) InterpretArgsForCall(i int) ([]interface{}, map[string]*model.Value, model.DataHandle) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
	return fake.interpretArgsForCall[i].expression, fake.interpretArgsForCall[i].scope, fake.interpretArgsForCall[i].opHandle
}

func (fake *FakeInterpreter) InterpretReturns(result1 []interface{}, result2 error) {
...
func (fake *FakeInterpreter) InterpretReturnsOnCall(i int, result1 []interface{}, result2 error) {
	fake.InterpretStub = nil
