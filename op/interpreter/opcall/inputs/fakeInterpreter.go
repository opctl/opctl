...
type FakeInterpreter struct {
	InterpretStub        func(inputArgs map[string]interface{}, inputParams map[string]*model.Param, parentOpDirHandle model.DataHandle, opPath string, scope map[string]*model.Value, opScratchDir string) (map[string]*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(inputArgs map[string]interface{}, inputParams map[string]*model.Param, parentOpDirHandle model.DataHandle, opPath string, scope map[string]*model.Value, opScratchDir string) (map[string]*model.Value, error) {
	...
	fake.interpretArgsForCall = append(fake.interpretArgsForCall, struct {
		...
		scope             map[string]*model.Value
		opScratchDir      string
	}{inputArgs, inputParams, parentOpDirHandle, opPath, scope, opScratchDir})
	fake.recordInvocation("Interpret", []interface{}{inputArgs, inputParams, parentOpDirHandle, opPath, scope, opScratchDir})
	fake.interpretMutex.Unlock()
	if fake.InterpretStub != nil {
		return fake.InterpretStub(inputArgs, inputParams, parentOpDirHandle, opPath, scope, opScratchDir)
	}
	if specificReturn {
...
func (fake *FakeInterpreter) InterpretArgsForCall(i int) (map[string]interface{}, map[string]*model.Param, model.DataHandle, string, map[string]*model.Value, string) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
	return fake.interpretArgsForCall[i].inputArgs, fake.interpretArgsForCall[i].inputParams, fake.interpretArgsForCall[i].parentOpDirHandle, fake.interpretArgsForCall[i].opPath, fake.interpretArgsForCall[i].scope, fake.interpretArgsForCall[i].opScratchDir
}
