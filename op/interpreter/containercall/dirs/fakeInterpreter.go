...
type FakeInterpreter struct {
	InterpretStub        func(opDirHandle model.DataHandle, scope map[string]*model.Value, scgContainerCallFiles map[string]string, scratchDirPath string) (map[string]string, error)
...
func (fake *FakeInterpreter) Interpret(opDirHandle model.DataHandle, scope map[string]*model.Value, scgContainerCallFiles map[string]string, scratchDirPath string) (map[string]string, error) {
