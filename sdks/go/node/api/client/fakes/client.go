...
func (fake *FakeAPIClient) AddAuth(arg1 context.Context, arg2 model.AddAuthReq) error {
...
func (fake *FakeAPIClient) AddAuthCallCount() int {
	fake.addAuthMutex.RLock()
	defer fake.addAuthMutex.RUnlock()
	return len(fake.addAuthArgsForCall)
}

func (fake *FakeAPIClient) AddAuthCalls(stub func(context.Context, model.AddAuthReq) error) {
	fake.addAuthMutex.Lock()
	defer fake.addAuthMutex.Unlock()
	fake.AddAuthStub = stub
}

func (fake *FakeAPIClient) AddAuthArgsForCall(i int) (context.Context, model.AddAuthReq) {
	fake.addAuthMutex.RLock()
	defer fake.addAuthMutex.RUnlock()
...
func (fake *FakeAPIClient) AddAuthReturns(result1 error) {
	fake.addAuthMutex.Lock()
	defer fake.addAuthMutex.Unlock()
...
func (fake *FakeAPIClient) AddAuthReturnsOnCall(i int, result1 error) {
	fake.addAuthMutex.Lock()
	defer fake.addAuthMutex.Unlock()
	fake.AddAuthStub = nil
...
func (fake *FakeAPIClient) GetData(arg1 context.Context, arg2 model.GetDataReq) (model.ReadSeekCloser, error) {
...
func (fake *FakeAPIClient) GetDataCallCount() int {
	fake.getDataMutex.RLock()
	defer fake.getDataMutex.RUnlock()
	return len(fake.getDataArgsForCall)
}

func (fake *FakeAPIClient) GetDataCalls(stub func(context.Context, model.GetDataReq) (model.ReadSeekCloser, error)) {
	fake.getDataMutex.Lock()
	defer fake.getDataMutex.Unlock()
	fake.GetDataStub = stub
}

func (fake *FakeAPIClient) GetDataArgsForCall(i int) (context.Context, model.GetDataReq) {
	fake.getDataMutex.RLock()
	defer fake.getDataMutex.RUnlock()
...
func (fake *FakeAPIClient) GetDataReturns(result1 model.ReadSeekCloser, result2 error) {
	fake.getDataMutex.Lock()
	defer fake.getDataMutex.Unlock()
...
func (fake *FakeAPIClient) GetDataReturnsOnCall(i int, result1 model.ReadSeekCloser, result2 error) {
	fake.getDataMutex.Lock()
	defer fake.getDataMutex.Unlock()
	fake.GetDataStub = nil
...
func (fake *FakeAPIClient) GetEventStream(arg1 context.Context, arg2 *model.GetEventStreamReq) (<-chan model.Event, error) {
...
func (fake *FakeAPIClient) GetEventStreamCallCount() int {
	fake.getEventStreamMutex.RLock()
	defer fake.getEventStreamMutex.RUnlock()
	return len(fake.getEventStreamArgsForCall)
}

func (fake *FakeAPIClient) GetEventStreamCalls(stub func(context.Context, *model.GetEventStreamReq) (<-chan model.Event, error)) {
	fake.getEventStreamMutex.Lock()
	defer fake.getEventStreamMutex.Unlock()
	fake.GetEventStreamStub = stub
}

func (fake *FakeAPIClient) GetEventStreamArgsForCall(i int) (context.Context, *model.GetEventStreamReq) {
	fake.getEventStreamMutex.RLock()
	defer fake.getEventStreamMutex.RUnlock()
...
func (fake *FakeAPIClient) GetEventStreamReturns(result1 <-chan model.Event, result2 error) {
	fake.getEventStreamMutex.Lock()
	defer fake.getEventStreamMutex.Unlock()
...
func (fake *FakeAPIClient) GetEventStreamReturnsOnCall(i int, result1 <-chan model.Event, result2 error) {
	fake.getEventStreamMutex.Lock()
	defer fake.getEventStreamMutex.Unlock()
	fake.GetEventStreamStub = nil
...
func (fake *FakeAPIClient) KillOp(arg1 context.Context, arg2 model.KillOpReq) error {
...
func (fake *FakeAPIClient) KillOpCallCount() int {
	fake.killOpMutex.RLock()
	defer fake.killOpMutex.RUnlock()
	return len(fake.killOpArgsForCall)
}

func (fake *FakeAPIClient) KillOpCalls(stub func(context.Context, model.KillOpReq) error) {
	fake.killOpMutex.Lock()
	defer fake.killOpMutex.Unlock()
	fake.KillOpStub = stub
}

func (fake *FakeAPIClient) KillOpArgsForCall(i int) (context.Context, model.KillOpReq) {
	fake.killOpMutex.RLock()
	defer fake.killOpMutex.RUnlock()
...
func (fake *FakeAPIClient) KillOpReturns(result1 error) {
	fake.killOpMutex.Lock()
	defer fake.killOpMutex.Unlock()
	fake.KillOpStub = nil
...
func (fake *FakeAPIClient) KillOpReturnsOnCall(i int, result1 error) {
	fake.killOpMutex.Lock()
	defer fake.killOpMutex.Unlock()
	fake.KillOpStub = nil
...
func (fake *FakeAPIClient) ListDescendants(arg1 context.Context, arg2 model.ListDescendantsReq) ([]*model.DirEntry, error) {
...
func (fake *FakeAPIClient) ListDescendantsCallCount() int {
	fake.listDescendantsMutex.RLock()
	defer fake.listDescendantsMutex.RUnlock()
	return len(fake.listDescendantsArgsForCall)
}

func (fake *FakeAPIClient) ListDescendantsCalls(stub func(context.Context, model.ListDescendantsReq) ([]*model.DirEntry, error)) {
	fake.listDescendantsMutex.Lock()
	defer fake.listDescendantsMutex.Unlock()
	fake.ListDescendantsStub = stub
}

func (fake *FakeAPIClient) ListDescendantsArgsForCall(i int) (context.Context, model.ListDescendantsReq) {
	fake.listDescendantsMutex.RLock()
	defer fake.listDescendantsMutex.RUnlock()
...
func (fake *FakeAPIClient) ListDescendantsReturns(result1 []*model.DirEntry, result2 error) {
	fake.listDescendantsMutex.Lock()
	defer fake.listDescendantsMutex.Unlock()
...
func (fake *FakeAPIClient) ListDescendantsReturnsOnCall(i int, result1 []*model.DirEntry, result2 error) {
	fake.listDescendantsMutex.Lock()
	defer fake.listDescendantsMutex.Unlock()
	fake.ListDescendantsStub = nil
...
func (fake *FakeAPIClient) Liveness(arg1 context.Context) error {
...
func (fake *FakeAPIClient) LivenessCallCount() int {
	fake.livenessMutex.RLock()
	defer fake.livenessMutex.RUnlock()
	return len(fake.livenessArgsForCall)
}

func (fake *FakeAPIClient) LivenessCalls(stub func(context.Context) error) {
	fake.livenessMutex.Lock()
	defer fake.livenessMutex.Unlock()
	fake.LivenessStub = stub
}

func (fake *FakeAPIClient) LivenessArgsForCall(i int) context.Context {
	fake.livenessMutex.RLock()
	defer fake.livenessMutex.RUnlock()
...
func (fake *FakeAPIClient) LivenessReturns(result1 error) {
	fake.livenessMutex.Lock()
	defer fake.livenessMutex.Unlock()
...
func (fake *FakeAPIClient) LivenessReturnsOnCall(i int, result1 error) {
	fake.livenessMutex.Lock()
	defer fake.livenessMutex.Unlock()
	fake.LivenessStub = nil
...
func (fake *FakeAPIClient) StartOp(arg1 context.Context, arg2 model.StartOpReq) (string, error) {
...
func (fake *FakeAPIClient) StartOpCallCount() int {
	fake.startOpMutex.RLock()
	defer fake.startOpMutex.RUnlock()
	return len(fake.startOpArgsForCall)
}

func (fake *FakeAPIClient) StartOpCalls(stub func(context.Context, model.StartOpReq) (string, error)) {
	fake.startOpMutex.Lock()
	defer fake.startOpMutex.Unlock()
	fake.StartOpStub = stub
}

func (fake *FakeAPIClient) StartOpArgsForCall(i int) (context.Context, model.StartOpReq) {
	fake.startOpMutex.RLock()
	defer fake.startOpMutex.RUnlock()
...
func (fake *FakeAPIClient) StartOpReturns(result1 string, result2 error) {
	fake.startOpMutex.Lock()
	defer fake.startOpMutex.Unlock()
...
func (fake *FakeAPIClient) StartOpReturnsOnCall(i int, result1 string, result2 error) {
	fake.startOpMutex.Lock()
	defer fake.startOpMutex.Unlock()
	fake.StartOpStub = nil
...
var _ client.APIClient = new(FakeAPIClient)
