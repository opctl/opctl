...
type FakeOpCaller struct {
	CallStub        func(context.Context, *model.OpCall, map[string]*model.Value, *string, *model.OpCallSpec) (map[string]*model.Value, error)
...
func (fake *FakeOpCaller) Call(arg1 context.Context, arg2 *model.OpCall, arg3 map[string]*model.Value, arg4 *string, arg5 *model.OpCallSpec) (map[string]*model.Value, error) {
	fake.callMutex.Lock()
...
func (fake *FakeOpCaller) CallCalls(stub func(context.Context, *model.OpCall, map[string]*model.Value, *string, *model.OpCallSpec) (map[string]*model.Value, error)) {
	fake.callMutex.Lock()
