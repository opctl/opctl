...
type FakeSerialLoopCaller struct {
	CallStub        func(context.Context, string, map[string]*model.Value, model.SerialLoopCallSpec, string, *string, string)
...
func (fake *FakeSerialLoopCaller) Call(arg1 context.Context, arg2 string, arg3 map[string]*model.Value, arg4 model.SerialLoopCallSpec, arg5 string, arg6 *string, arg7 string) {
	fake.callMutex.Lock()
...
func (fake *FakeSerialLoopCaller) CallCalls(stub func(context.Context, string, map[string]*model.Value, model.SerialLoopCallSpec, string, *string, string)) {
	fake.callMutex.Lock()
