...
type FakeFsPathConverter struct {
	LocalToEngineStub        func(string) string
...
func (fake *FakeFsPathConverter) LocalToEngine(arg1 string) string {
	...
	fake.recordInvocation("LocalToEngine", []interface{}{arg1})
	fake.localToEngineMutex.Unlock()
	if fake.LocalToEngineStub != nil {
		return fake.LocalToEngineStub(arg1)
	}
	if specificReturn {
		return ret.result1
	}
	fakeReturns := fake.localToEngineReturns
...
func (fake *FakeFsPathConverter) LocalToEngineCalls(stub func(string) string) {
	fake.localToEngineMutex.Lock()
	defer fake.localToEngineMutex.Unlock()
	fake.LocalToEngineStub = stub
}

func (fake *FakeFsPathConverter) LocalToEngineArgsForCall(i int) string {
	fake.localToEngineMutex.RLock()
	defer fake.localToEngineMutex.RUnlock()
	argsForCall := fake.localToEngineArgsForCall[i]
