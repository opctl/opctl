module github.com/opctl/opctl/sdks/go
...
require (
	...
	github.com/docker/distribution v0.0.0-20190605223428-dcfe05ce6cff
	...
	github.com/golang-interfaces/gopkg.in-src-d-go-git.v4 v0.0.0-20180127214738-c86b4da0f9b3
