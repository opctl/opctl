...
type FakeInterpreter struct {
	InterpretStub        func(interface{}, types.DataHandle, map[string]*types.Value) (*types.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 interface{}, arg2 types.DataHandle, arg3 map[string]*types.Value) (*types.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(interface{}, types.DataHandle, map[string]*types.Value) (*types.Value, error)) {
	fake.interpretMutex.Lock()
