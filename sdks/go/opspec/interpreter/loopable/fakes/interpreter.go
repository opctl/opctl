...
type FakeInterpreter struct {
	InterpretStub        func(interface{}, map[string]*model.Value) (*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 interface{}, arg2 map[string]*model.Value) (*model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(interface{}, map[string]*model.Value) (*model.Value, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (interface{}, map[string]*model.Value) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
