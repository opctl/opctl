...
type FakeInterpreter struct {
	InterpretStub        func(interface{}, model.DataHandle, map[string]*model.Value) (*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 interface{}, arg2 model.DataHandle, arg3 map[string]*model.Value) (*model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(interface{}, model.DataHandle, map[string]*model.Value) (*model.Value, error)) {
	fake.interpretMutex.Lock()
...
var _ loopable.Interpreter = new(FakeInterpreter)
