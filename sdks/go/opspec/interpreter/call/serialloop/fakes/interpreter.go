...
type FakeInterpreter struct {
	InterpretStub        func(model.SerialLoopCallSpec, map[string]*model.Value) (*model.SerialLoopCall, error)
	interpretMutex       sync.RWMutex
	interpretArgsForCall []struct {
		arg1 model.SerialLoopCallSpec
		arg2 map[string]*model.Value
	}
	interpretReturns struct {
		result1 *model.SerialLoopCall
		result2 error
	}
...
func (fake *FakeInterpreter) Interpret(arg1 model.SerialLoopCallSpec, arg2 map[string]*model.Value) (*model.SerialLoopCall, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(model.SerialLoopCallSpec, map[string]*model.Value) (*model.SerialLoopCall, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (model.SerialLoopCallSpec, map[string]*model.Value) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
...
func (fake *FakeInterpreter) InterpretReturns(result1 *model.SerialLoopCall, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
...
func (fake *FakeInterpreter) InterpretReturnsOnCall(i int, result1 *model.SerialLoopCall, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = nil
