...
type FakeInterpreter struct {
	InterpretStub        func(string, map[string]*model.Value) (bool, error)
...
func (fake *FakeInterpreter) Interpret(arg1 string, arg2 map[string]*model.Value) (bool, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(string, map[string]*model.Value) (bool, error)) {
	fake.interpretMutex.Lock()
