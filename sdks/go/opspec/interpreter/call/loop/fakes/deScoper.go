...
type FakeDeScoper struct {
	DeScopeStub        func(map[string]*model.Value, interface{}, *model.LoopVarsSpec, map[string]*model.Value) map[string]*model.Value
	deScopeMutex       sync.RWMutex
	deScopeArgsForCall []struct {
		arg1 map[string]*model.Value
		arg2 interface{}
		arg3 *model.LoopVarsSpec
...
func (fake *FakeDeScoper) DeScope(arg1 map[string]*model.Value, arg2 interface{}, arg3 *model.LoopVarsSpec, arg4 map[string]*model.Value) map[string]*model.Value {
...
func (fake *FakeDeScoper) DeScopeCalls(stub func(map[string]*model.Value, interface{}, *model.LoopVarsSpec, map[string]*model.Value) map[string]*model.Value) {
	fake.deScopeMutex.Lock()
	defer fake.deScopeMutex.Unlock()
	fake.DeScopeStub = stub
}

func (fake *FakeDeScoper) DeScopeArgsForCall(i int) (map[string]*model.Value, interface{}, *model.LoopVarsSpec, map[string]*model.Value) {
	fake.deScopeMutex.RLock()
	defer fake.deScopeMutex.RUnlock()
