...
type FakeInterpreter struct {
	InterpretStub        func(types.DataHandle, types.SCGParallelLoopCall, map[string]*types.Value) (*types.DCGParallelLoopCall, error)
	interpretMutex       sync.RWMutex
	interpretArgsForCall []struct {
		arg1 types.DataHandle
		arg2 types.SCGParallelLoopCall
		arg3 map[string]*types.Value
	}
	interpretReturns struct {
		result1 *types.DCGParallelLoopCall
		result2 error
	}
...
func (fake *FakeInterpreter) Interpret(arg1 types.DataHandle, arg2 types.SCGParallelLoopCall, arg3 map[string]*types.Value) (*types.DCGParallelLoopCall, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(types.DataHandle, types.SCGParallelLoopCall, map[string]*types.Value) (*types.DCGParallelLoopCall, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (types.DataHandle, types.SCGParallelLoopCall, map[string]*types.Value) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
...
func (fake *FakeInterpreter) InterpretReturns(result1 *types.DCGParallelLoopCall, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
...
func (fake *FakeInterpreter) InterpretReturnsOnCall(i int, result1 *types.DCGParallelLoopCall, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = nil
