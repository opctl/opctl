...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, *model.SCGContainerCallImage, model.DataHandle) (*model.DCGContainerCallImage, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 *model.SCGContainerCallImage, arg3 model.DataHandle) (*model.DCGContainerCallImage, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, *model.SCGContainerCallImage, model.DataHandle) (*model.DCGContainerCallImage, error)) {
	fake.interpretMutex.Lock()
