...
type FakeInterpreter struct {
	InterpretStub        func(model.DataHandle, map[string]*model.Value, map[string]string, string) (map[string]string, error)
...
func (fake *FakeInterpreter) Interpret(arg1 model.DataHandle, arg2 map[string]*model.Value, arg3 map[string]string, arg4 string) (map[string]string, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(model.DataHandle, map[string]*model.Value, map[string]string, string) (map[string]string, error)) {
	fake.interpretMutex.Lock()
...
var _ dirs.Interpreter = new(FakeInterpreter)
