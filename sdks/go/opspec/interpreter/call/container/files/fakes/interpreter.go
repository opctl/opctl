...
type FakeInterpreter struct {
	InterpretStub        func(model.DataHandle, map[string]*model.Value, map[string]interface{}, string) (map[string]string, error)
...
func (fake *FakeInterpreter) Interpret(arg1 model.DataHandle, arg2 map[string]*model.Value, arg3 map[string]interface{}, arg4 string) (map[string]string, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(model.DataHandle, map[string]*model.Value, map[string]interface{}, string) (map[string]string, error)) {
	fake.interpretMutex.Lock()
...
var _ files.Interpreter = new(FakeInterpreter)
