...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, map[string]interface{}, string) (map[string]string, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 map[string]interface{}, arg3 string) (map[string]string, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, map[string]interface{}, string) (map[string]string, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (map[string]*model.Value, map[string]interface{}, string) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
