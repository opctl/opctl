...
type FakeInterpreter struct {
	InterpretStub        func(opHandle types.DataHandle, scope map[string]*types.Value, scgContainerCallFiles map[string]interface{}, scratchDirPath string) (map[string]string, error)
...
func (fake *FakeInterpreter) Interpret(opHandle types.DataHandle, scope map[string]*types.Value, scgContainerCallFiles map[string]interface{}, scratchDirPath string) (map[string]string, error) {
...
func (fake *FakeInterpreter) InterpretArgsForCall(i int) (types.DataHandle, map[string]*types.Value, map[string]interface{}, string) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
