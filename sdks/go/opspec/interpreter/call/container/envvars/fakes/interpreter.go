...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, interface{}) (map[string]string, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 interface{}) (map[string]string, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, interface{}) (map[string]string, error)) {
	fake.interpretMutex.Lock()
