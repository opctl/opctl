...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, map[string]string, string) (map[string]string, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 map[string]string, arg3 string) (map[string]string, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, map[string]string, string) (map[string]string, error)) {
	fake.interpretMutex.Lock()
...
var _ sockets.Interpreter = new(FakeInterpreter)
