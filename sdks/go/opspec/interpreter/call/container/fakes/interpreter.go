...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, *model.ContainerCallSpec, string, string) (*model.ContainerCall, error)
	interpretMutex       sync.RWMutex
	interpretArgsForCall []struct {
		arg1 map[string]*model.Value
		arg2 *model.ContainerCallSpec
		arg3 string
		arg4 string
	}
	interpretReturns struct {
		result1 *model.ContainerCall
		result2 error
	}
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 *model.ContainerCallSpec, arg3 string, arg4 string) (*model.ContainerCall, error) {
	...
	fake.recordInvocation("Interpret", []interface{}{arg1, arg2, arg3, arg4})
	fake.interpretMutex.Unlock()
	if fake.InterpretStub != nil {
		return fake.InterpretStub(arg1, arg2, arg3, arg4)
	}
	if specificReturn {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, *model.ContainerCallSpec, string, string) (*model.ContainerCall, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (map[string]*model.Value, *model.ContainerCallSpec, string, string) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
...
func (fake *FakeInterpreter) InterpretReturns(result1 *model.ContainerCall, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
...
func (fake *FakeInterpreter) InterpretReturnsOnCall(i int, result1 *model.ContainerCall, result2 error) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = nil
