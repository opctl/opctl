...
type FakeInterpreter struct {
	InterpretStub        func(map[string]interface{}, map[string]*model.Param, string, map[string]*model.Value, string) (map[string]*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]interface{}, arg2 map[string]*model.Param, arg3 string, arg4 map[string]*model.Value, arg5 string) (map[string]*model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]interface{}, map[string]*model.Param, string, map[string]*model.Value, string) (map[string]*model.Value, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (map[string]interface{}, map[string]*model.Param, string, map[string]*model.Value, string) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
...
var _ inputs.Interpreter = new(FakeInterpreter)
