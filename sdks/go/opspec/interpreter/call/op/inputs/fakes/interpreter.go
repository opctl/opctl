...
type FakeInterpreter struct {
	InterpretStub        func(map[string]interface{}, map[string]*model.Param, model.DataHandle, string, map[string]*model.Value, string) (map[string]*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]interface{}, arg2 map[string]*model.Param, arg3 model.DataHandle, arg4 string, arg5 map[string]*model.Value, arg6 string) (map[string]*model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]interface{}, map[string]*model.Param, model.DataHandle, string, map[string]*model.Value, string) (map[string]*model.Value, error)) {
	fake.interpretMutex.Lock()
