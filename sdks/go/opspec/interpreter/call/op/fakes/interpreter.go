...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, *model.OpCallSpec, string, string) (*model.OpCall, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 *model.OpCallSpec, arg3 string, arg4 string) (*model.OpCall, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, *model.OpCallSpec, string, string) (*model.OpCall, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (map[string]*model.Value, *model.OpCallSpec, string, string) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
...
var _ op.Interpreter = new(FakeInterpreter)
