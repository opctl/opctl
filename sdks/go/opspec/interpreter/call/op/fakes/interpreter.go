...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, *model.SCGOpCall, string, model.DataHandle, string) (*model.DCGOpCall, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 *model.SCGOpCall, arg3 string, arg4 model.DataHandle, arg5 string) (*model.DCGOpCall, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, *model.SCGOpCall, string, model.DataHandle, string) (*model.DCGOpCall, error)) {
	fake.interpretMutex.Lock()
