...
type FakeInterpreter struct {
	InterpretStub        func(interface{}, map[string]*model.Value, model.DataHandle) (model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 interface{}, arg2 map[string]*model.Value, arg3 model.DataHandle) (model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(interface{}, map[string]*model.Value, model.DataHandle) (model.Value, error)) {
	fake.interpretMutex.Lock()
...
var _ value.Interpreter = new(FakeInterpreter)
