...
type FakeInterpreter struct {
	InterpretStub        func(interface{}, map[string]*types.Value, types.DataHandle) (types.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 interface{}, arg2 map[string]*types.Value, arg3 types.DataHandle) (types.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(interface{}, map[string]*types.Value, types.DataHandle) (types.Value, error)) {
	fake.interpretMutex.Lock()
	defer fake.interpretMutex.Unlock()
	fake.InterpretStub = stub
}

func (fake *FakeInterpreter) InterpretArgsForCall(i int) (interface{}, map[string]*types.Value, types.DataHandle) {
	fake.interpretMutex.RLock()
	defer fake.interpretMutex.RUnlock()
