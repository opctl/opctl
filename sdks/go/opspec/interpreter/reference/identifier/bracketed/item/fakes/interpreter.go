...
type FakeInterpreter struct {
	InterpretStub        func(string, model.Value) (*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 string, arg2 model.Value) (*model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(string, model.Value) (*model.Value, error)) {
	fake.interpretMutex.Lock()
...
var _ item.Interpreter = new(FakeInterpreter)
