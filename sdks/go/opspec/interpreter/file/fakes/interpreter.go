...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, interface{}, model.DataHandle, string) (*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 interface{}, arg3 model.DataHandle, arg4 string) (*model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, interface{}, model.DataHandle, string) (*model.Value, error)) {
	fake.interpretMutex.Lock()
