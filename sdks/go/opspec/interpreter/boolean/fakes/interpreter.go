...
type FakeInterpreter struct {
	InterpretStub        func(map[string]*model.Value, interface{}, model.DataHandle) (*model.Value, error)
...
func (fake *FakeInterpreter) Interpret(arg1 map[string]*model.Value, arg2 interface{}, arg3 model.DataHandle) (*model.Value, error) {
...
func (fake *FakeInterpreter) InterpretCalls(stub func(map[string]*model.Value, interface{}, model.DataHandle) (*model.Value, error)) {
	fake.interpretMutex.Lock()
...
var _ boolean.Interpreter = new(FakeInterpreter)
